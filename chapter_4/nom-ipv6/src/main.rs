...
// Convert a given slice of u8 to an array of 16 u8 given by [u8; 16]
...
// Converts a reference to a slice [u8] to an instance of std::net::Ipv6Addr
fn to_ipv6_address(input: &[u8]) -> Ipv6Addr {
    let array = slice_to_array(input);
    Ipv6Addr::from(array)
}

// Parsers for each individual part of the header
...
fn main() {
    ...
    let bytes = [
        0x60, 0x00, 0x08, 0x19, 0x80, 0x00, 0x14, 0x06, 0x40, 0x2a, 0x02, 0x0c, 0x7d, 0x2e, 0x5d,
        0x5d, 0x00, 0x24, 0xec, 0x4d, 0xd1, 0xc8, 0xdf, 0xbe, 0x75, 0x2a, 0x00, 0x14, 0x50, 0x40,
        0x0c, 0x0c, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xbd,
    ];
